...
const ContactModal = () => {
  ...
  return (
    <>
      ...
      <button 
        onClick={toggleModal}
        className="bg-askia-blue text-white px-8 py-4 rounded-full font-bold hover:scale-105 transition-all shadow-xl shadow-askia-blue/20 text-sm md:text-base"
      >
